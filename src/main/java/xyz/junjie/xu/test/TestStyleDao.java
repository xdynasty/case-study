...
class TestStyleDao {
	...
	void testGetStyleById() {
		Style expected = new Style(1, new Product(1, "LOGO OVER COTTON & WOOL KNIT SWEATER", "CLOTHING/KNITWEAR", new String[] {"Embroidered front logo", "Model is wearing a size M", "Model height: 1.88m", 
